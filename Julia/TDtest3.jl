...
for d = 1:3
    ...
    for m = 1:10000
        T[2:n-1] = P[2:n-1,2:n-1]*T[2:n-1] .+ rT[2:n-1]
    end
    ...
    for m = 1:10000
        Q[2:n-1] = P[2:n-1,2:n-1]*Q[2:n-1] .+ rQ[2:n-1]
    end
    ...
    B[1,1] = 1
    B[1,2:n-1] = zeros(n-2)
    B[2:n-1,1] = alpha .* rT[2:n-1]
    B[2:n-1,2:n-1] = I - alpha .* A[2:n-1,2:n-1]
    ...
    for m = 1:10000
        Teig[2:n-1] = P[2:n-1,2:n-1]*Teig[2:n-1] .+ rT[2:n-1]
    end

    println(norm(Teig[2:n-1]-T[2:n-1]))
    ...
    # AB = zeros(n-1,2)
    # AB[1,:] = B[1,:]
    # AB[2:n-1,:] = B[2:n-1,:] .- alpha .* A[2:n-1,2:n-1]*B[2:n-1,:]
    # AB[2:n-1,1] = B[2:n-1,1] .+ alpha .* rT[2:n-1]

    # println(size(B))
    # println(size(B'))
    # println(size(AB))

    # eigvals, eigvecs = eigen(B'*AB)
