...
Along with the algorithm code, the repo also contains a copy of the Lim and Weare ArXiv paper introducing the algorithm. Please try the examples, compare your results to the reference values in the paper, and experiment!
